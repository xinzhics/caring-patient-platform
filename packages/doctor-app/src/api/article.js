...
export function userVoiceTaskPage (data) {
  return axiosApi({
    method: 'POST',
    url: `${apiUrl}/ai/articleUserVoiceTask/page`,
    data
  })
}
...
export function articleTaskPage (data) {
  return axiosApi({
    method: 'POST',
    url: `${apiUrl}/ai/articleTask/draftPage`,
    data
  })
}
...
export function podcastPage (data) {
  return axiosApi({
    method: 'POST',
    url: `${apiUrl}/ai/podcast/creation/page`,
    data
  })
}
...
export function getArticleContentAll (taskId) {
  return axiosApi({
    method: 'GET',
    url: `${apiUrl}/ai/articleTask/getArticleContentAll/${taskId}`,
  })
}
...
export function getPodcast (taskId) {
  return axiosApi({
    method: 'GET',
    url: `${apiUrl}/ai/podcast/getPodcast?podcastId=${taskId}`,
  })
}
...
export function getVoiceTask (taskId) {
  return axiosApi({
    method: 'GET',
    url: `${apiUrl}/ai/articleUserVoiceTask/${taskId}`,
  })
}
