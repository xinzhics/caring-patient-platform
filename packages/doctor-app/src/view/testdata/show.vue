<template>
  <section ref="mianscroll" class="allContent">
    ...
    <div class="choosetime" v-if="EchartsData.showTrend">
      ...
      <img class="quanping" style="padding-right: 15px" :src="require('@/assets/my/test_data_enlarge.png')" @click="HorizontalScreen"/>
    </div>
      ...
      <div>
        <div class="ckqj" v-for="(item,index) in EchartsData.ydataList" :key="index"
          ...
          <div style="display: flex"  v-if="item.showReferenceTargetValue===true">
            ...
            <div class="updata">
              <img id="updata" src="../../images/updata.png" @click="editReference(item)" alt="">
            </div>
          </div>
        </div>
      </div>
            ...
            <div v-else style="background: white; marginTop: 15px">
              <group>
                <cell>
                  <div slot="title" style=" margin-left: 5px;">
                    ...
                    <span style="margin-left: 8px; width: 130px;"> {{ getTime(i.createTime, 'YYYY-MM-DD HH:mm') }} </span>
                  </div>
                  <div slot="value">
                  <span v-if="i.dataFeedBack"
                        :style="{background: getDataFeedBack(i.dataFeedBack) !== 1 ? '#FF5A5A' : '#66E0A7'}"
              ...
              <div style="padding: 0px 15px 15px 15px">
                <div style="border-radius: 10px; padding-left: 15px; font-size: 14px;">
                  ...
                  <div style="display: flex; align-items: center; justify-content: center; color: #929292" @click.stop="openContent(k)">
