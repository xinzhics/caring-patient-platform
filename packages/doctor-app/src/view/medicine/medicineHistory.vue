<template>
  <section style="height: 100vh; background: #F5F5F5">
    <x-header :left-options="{backText: '',showBack: true}">用药记录</x-header>
            ...
            <div style="margin: 15px; background: white; padding: 0px 15px; border-radius: 8px;">
              ...
              <div style="padding: 10px 0px;">
                <div style="display: flex">
                  ...
                  <!--右侧-->
<!--                  <div>-->
<!--                    <div style="font-size: 14px; color: #333333" v-for="(newI, newK) in getArray(i, 'CREATED')" :key="newK">{{newI.medicineName}}</div>-->
<!--                  </div>-->
