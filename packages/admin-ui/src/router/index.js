...
const constRouter = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'chatRecord',
        component: resolve => require(['@/views/caring/ucenter/patient/chatRecord'], resolve),
        name: 'chatRecord',
        meta: {title: '沟通记录', icon: '', breadcrumb: true}
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: resolve => require(['@/views/caring/sms/manage/Edit'], resolve),
        name: 'smsEdit',
        meta: {
        ...
        if (!userRouter) {
          loginApi.getRouter({}).then((response) => {
            ...
            asyncRouter[0].children.push({
              alwaysShow: false,
              component: "caring/ucenter/patient/watch",
              hidden: true,
              meta: {title: "查看", icon: "", breadcrumb: true},
              name: "查看",
              path: "/ucenter/watch",
              sortValue: 0,
            })
