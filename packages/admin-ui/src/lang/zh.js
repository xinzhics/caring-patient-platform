export default {
  ...
  table: {
    channel: {
      ...
      sort: '排序',
      channelType: '栏目类型',
      ownerType: '所有者类型，SYS表示系统，TENANT表示项目',
    },
    channelContent: {
      id: 'ID',
      channelId: '所属栏目',
    ...
    doctor: {
      ...
      hospitalName: '医生姓名',
      qrCode: '患者关注码',
      businessCardQrCode: '医生名片 跟患者关住码一样的',
      deptartmentName: '科室名称',
      organCode: '所属机构代码',
      organName: '所属机构名称',
      birthday: '出生年月',
      lastLoginIp: '最后登录IP',
      totalLoginTimes: '登录次数',
      sex: '性别',
      lastLoginTime: '最后登录时间，时间戳类型',
      extraInfo: '扩展内容',
      loginName: '默认医生的登录名',
      classCode: '权限代码',
    },
    ...
    patient: {
      id: 'ID',
      serviceAdvisorId: '服务专员ID',
      serviceAdvisorName: '服务专员',
      nickName: '微信昵称',
      mobile: '手机号码',
      sex: '性别',
      name: '姓名',
      ...
      status: '状态',
      diagnosisId: '诊断类型ID',
      diagnosisName: '诊断类型名称',
      wxAppId: '所属公众号ID',
      openId: '微信openid',
      avatar: '头像',
      imAccount: '环信账号',
      remark: 'remark',
      isCompleteEnterGroup: '是否完成入组信息',
      examineCount: '随访计划完成次数',
      ckd: '病分期',
      nursingTime: '随访计划开始时间',
      hospitalName: '医院名称',
      certificateNo: '身份证号',
      code: '会员标识码',
      agreeAgreement: '是否同意入组协议',
      grandTotalCheck: '用户累计打卡天数',
      successiveCheck: '用户连续打卡天数',
      height: '身高',
      weight: '体重',
      organId: '所属机构ID',
      organCode: '所属机构代码',
  ...
  tips: {
    ...
    iframeGrant: '用户名：caring 密码：caring',
    notEqual: '两次输入不一致',
