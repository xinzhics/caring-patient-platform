export default {
  ...
  table: {
    ...
    channelContent: {
      ...
      icon: 'icon',
      sourceId: 'sourceId',
      cSourceEntityClass: 'cSourceEntityClass',
      content: 'content',
      link: 'link',
      sort: 'sort',
      isTop: 'isTop',
    ...
    contentReply: {
      id: 'ID',
      cParentCommentId: 'cParentCommentId',
      cReplierId: 'cReplierId',
      cContentId: 'cContentId',
      content: 'content',
      nAuditStatus: 'nAuditStatus',
      cReplierWxName: 'cReplierWxName',
      cReplierAvatar: 'cReplierAvatar',
    },
    doctor: {
      id: 'ID',
      name: 'name',
      ...
      idCardImgB: 'idCardImgB',
      wxAppId: 'wxAppId',
      openId: 'openId',
      imAccount: 'imAccount',
      hospitalName: 'hospitalName',
      qrCode: 'qrCode',
      businessCardQrCode: 'businessCardQrCode',
    ...
    nursingStaff: {
      ...
      avatar: 'avatar',
      mobile: 'mobile',
      passwordStrongLevel: 'passwordStrongLevel',
      imAccount: 'imAccount',
    ...
    patient: {
      ...
      grandTotalCheck: 'grandTotalCheck',
      successiveCheck: 'successiveCheck',
      height: 'height',
      weight: 'weight',
      organId: 'organId',
      organCode: 'organCode',
  ...
  tips: {
    ...
    neverLogin: 'Never logged in to the caring system',
    nothing: 'Nothing',
    ...
    iframeGrant: 'Userame: caring Password: caring',
