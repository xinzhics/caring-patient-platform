          ...
          <el-row :gutter="10">
            ...
            <el-col :sm="24" :xs="24">
              <div class="user-visits">
                <el-row style="margin-bottom: .7rem;font-size:18px">
                  <el-col :offset="4" :span="4">服务专员</el-col>
                  <!-- {{ $t('common.todayIp') }} -->
                  <el-col :offset="4" :span="4">会员</el-col>
                  <!-- {{ $t('common.todayVisit') }} -->
                  <el-col :offset="4" :span="4">医生</el-col>
                  <!-- {{ $t('common.TotalVisit') }} -->
                </el-row>
                <el-row>
      ...
      initIndexData: function () {
        dashboardApi.getVisitList({})
          .then((response) => {
            ...
            const data = res.data
            this.todayIp = Number(data.totalNursingStaff)
            this.totalVisit = Number(data.totalDoctor)
            this.todayVisit = Number(data.totalPatient)
