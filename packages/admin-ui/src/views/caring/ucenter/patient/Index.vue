<template>
  <div class="app-container">
    ...
    <el-table :data="tableData.records" :key="tableKey" @cell-click="cellClick"
      ...
      <!-- <el-table-column :label="$t('table.patient.serviceAdvisorId')" :show-overflow-tooltip="true" align="center"
                       prop="serviceAdvisorId"
                       width="">
        <template slot-scope="scope">
          <span>{{ scope.row.serviceAdvisorId }}</span>
        </template>
      </el-table-column> -->
      <el-table-column :label="$t('table.patient.healthName')" :show-overflow-tooltip="true" align="center"
                       prop="classCode"
                       width="">
        <template>
          <span style="color:#1890FF;font-weight:600;cursor: pointer;">[查看]</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.patient.serviceAdvisorName')" :show-overflow-tooltip="true" align="center"
                       prop="serviceAdvisorName"
                       width="">
        <template slot-scope="scope">
          <span style="color:#1890FF;font-weight:600">{{ scope.row.serviceAdvisorName }}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column :label="$t('table.patient.nickName')" :show-overflow-tooltip="true" align="center"
                       prop="nickName"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.birthday')" :show-overflow-tooltip="true" align="center"
                       prop="birthday"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.groupName')" :show-overflow-tooltip="true" align="center"
                       prop="groupName"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.doctorId')" :show-overflow-tooltip="true" align="center"
                       prop="doctorId"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.doctorName')" :show-overflow-tooltip="true" align="center"
                       prop="doctorName"
                       width="">
        <template slot-scope="scope">
          <span style="color:#1890FF;font-weight:600">{{ scope.row.doctorName }}</span>
        </template>
      </el-table-column>

      <!--聊天记录查询-->
      <el-table-column :label="$t('table.patient.chatRecord')" :show-overflow-tooltip="true" align="center"
                       prop="classCode"
                       width="">
        <template>
          <span style="color:#1890FF;font-weight:600;cursor: pointer;">[查看]</span>
...
3，未注册取关 -->
          ...
          <span v-if="scope.row.status === 2">已注册取关</span>
          <span v-if="scope.row.status === 3">未注册取关</span>
        </template>
      </el-table-column>
      <!-- <el-table-column :label="$t('table.patient.diagnosisId')" :show-overflow-tooltip="true" align="center"
                       prop="diagnosisId"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.diagnosisName')" :show-overflow-tooltip="true" align="center"
                       prop="diagnosisName"
                       width="">
        <template slot-scope="scope">
      ...
      <!-- <el-table-column :label="$t('table.patient.imAccount')" :show-overflow-tooltip="true" align="center"
                       prop="imAccount"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.isCompleteEnterGroup')" :show-overflow-tooltip="true" align="center"
                       prop="isCompleteEnterGroup"
                       width="">
        <template slot-scope="scope">
          <span v-if="scope.row.isCompleteEnterGroup === 1">是</span>
          <span v-else>否</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.patient.examineCount')" :show-overflow-tooltip="true" align="center"
                       prop="examineCount"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.nursingTime')" :show-overflow-tooltip="true" align="center"
                       prop="nursingTime"
                       width="170">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.hospitalName')" :show-overflow-tooltip="true" align="center"
                       prop="hospitalName"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.certificateNo')" :show-overflow-tooltip="true" align="center"
                       prop="certificateNo"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.agreeAgreement')" :show-overflow-tooltip="true" align="center"
                       prop="agreeAgreement"
                       width="">
        <template slot-scope="scope"> -->
          <!--          agreeAgreement: '是否同意 入组协议 （0； 同意 1 ）',-->
          <!-- <span v-if="scope.row.agreeAgreement === 1">同意</span>
          <span v-else> 不同意</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.patient.grandTotalCheck')" :show-overflow-tooltip="true" align="center"
                       prop="grandTotalCheck"
                       width="">
        <template slot-scope="scope">
          <span>{{ scope.row.grandTotalCheck }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.patient.successiveCheck')" :show-overflow-tooltip="true" align="center"
                       prop="successiveCheck"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.organCode')" :show-overflow-tooltip="true" align="center"
                       prop="organCode"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.organName')" :show-overflow-tooltip="true" align="center"
                       prop="organName"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.lastLoginIp')" :show-overflow-tooltip="true" align="center"
                       prop="lastLoginIp"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.lastLoginTime')" :show-overflow-tooltip="true" align="center"
                       prop="lastLoginTime"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.totalLoginTimes')" :show-overflow-tooltip="true" align="center"
      ...
      <el-table-column :label="$t('table.patient.extraInfo')" :show-overflow-tooltip="true" align="center"
                       prop="extraInfo"
                       width="">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.patient.completeEnterGroupTime')" :show-overflow-tooltip="true" align="center"
                       prop="completeEnterGroupTime"
                       width="170">
        <template slot-scope="scope">
          <span>{{ scope.row.completeEnterGroupTime }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.patient.classCode')" :show-overflow-tooltip="true" align="center"
                       prop="classCode"
                       width="">
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      fileImport: {
        isVisible: false,
        type: "import",
        action: `${process.env.VUE_APP_BASE_API}/用户中心/patient/import`
      },
      tableKey: 0,
  ...
  methods: {
    ...
    cellClick(row, column) {
      if(column.label==='健康档案'){
        this.$router.push({path:'/ucenter/watch',query:{id:row.id}})
      }else if (column.label === '沟通记录') {
        this.$router.push({path: '/ucenter/chatRecord', query: {id: row.id}})
      }
