...
<script>
  import commonTree from '@/components/caring/CommonTree.vue'
      ...
      menuComponent() {
        ...
        if (this.menu.path && this.menu.path !== '/') {
          ...
          if (isUrl) {
            ...
            // comp = `前端组件：src/views/caring${this.menu.path}/Index.vue`
            comp = `组件路径：src/views/${this.menu.component}.vue`
          }
        } else {
          comp = `组件路径：src/views/caring/Index.vue`
        }
        return comp
      }
    },
    ...
    methods: {
      ...
      computedComponent() {
        ...
        if (isUrl) {
          ...
          if (this.menu.path) {
            this.menu.component = `caring${this.menu.path}/Index`
          } else {
            this.menu.component = `caring/Index`
          }
        }
      },
      initMenuTree() {
