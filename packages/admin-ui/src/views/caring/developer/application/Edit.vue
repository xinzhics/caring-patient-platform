  ...
  export default {
    ...
    data() {
      return {
        ...
        serviceList: [
          {id: "caring-authority-server", name: "权限服务"},
          {id: "caring-file-server", name: "文件服务"},
          {id: "caring-msgs-server", name: "消息服务"},
          {id: "caring-demo-server", name: "演示服务"},
          {id: "caring-order-server", name: "订单服务"},
        ]
      }
    },
    computed: {
