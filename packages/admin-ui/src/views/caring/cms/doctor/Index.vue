  ...
  <div class="app-container">
    ...
    <el-table :data="tableData.records" :key="tableKey" @cell-click="cellClick"
      ...
      <el-table-column :label="$t('table.doctor.hospitalId')" :show-overflow-tooltip="true" align="center" prop="hospitalId"
                        width="">
        <template slot-scope="scope">
          <span>{{ scope.row.hospitalId }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('table.doctor.classCode')" :show-overflow-tooltip="true" align="center" prop="classCode"
                        width="">
        <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      fileImport: {
        isVisible: false,
        type: "import",
        action: `${process.env.VUE_APP_BASE_API}/ucenter/doctor/import`
      },
      tableKey: 0,
