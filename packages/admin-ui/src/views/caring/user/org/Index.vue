...
<!--              </el-form-item>-->
              <el-form-item
                :label="$t('table.org.province')"
                prop="province"
              >
                <el-input v-model="org.province" />
              </el-form-item>
              <el-form-item
                :label="$t('table.org.city')"
                prop="city"
              >
                <el-input v-model="org.city" />
              </el-form-item>
              <el-form-item
                :label="$t('table.org.area')"
                prop="area"
              >
                <el-input v-model="org.area" />
              </el-form-item>
              <el-form-item
                :label="$t('table.org.head')"
                prop="head"
              >
                <el-input v-model="org.head" />
              </el-form-item>
              <el-form-item
                :label="$t('table.org.tel')"
                prop="tel"
              >
                <el-input v-model="org.tel" />
              </el-form-item>
              <el-form-item
                :label="$t('table.org.detailedAddress')"
                prop="head"
              >
                <el-input v-model="org.detailedAddress"/>
              </el-form-item>
              <!--              <el-form-item-->
              <!--                :label="$t('table.org.type')"-->
              <!--                prop="type"-->
              <!--              >-->
              <!--                <el-radio-group v-model="org.type.key">-->
              <!--                  <el-radio-button-->
              <!--                    v-for="(item, key, index) in dicts.ORG_TYPE"-->
              <!--                    :key="index"-->
              <!--                    :label="key"-->
              <!--                    :value="key"-->
              <!--                  >-->
...
import FileImport from "@/components/caring/Import"
