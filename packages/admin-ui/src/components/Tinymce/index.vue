...
// import language_zh_CN from './components/zh_CN.js'
...
export default {
  ...
  methods: {
    ...
    initTinymce () {
      const _this = this
      window.tinymce.init({
        // language_url:language_zh_CN,
        fontsize_formats: "8px 10px 12px 14px 15px 16px 17px 18px 20px 24px 26px 36px", // 第二步
