...
axios.interceptors.request.use(config => {
    ...
    const reqPath = config.url.replace(process.env.VUE_APP_DEV_REQUEST_DOMAIN_PREFIX,"");
    if (reqPath === "/api/tenant/cmsConfig/content/page" || reqPath === "/api/tenant/cmsConfig/channel/page" ) {
