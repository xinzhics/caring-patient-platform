<template>
  <section ref="mianscroll" class="allContent">
    <van-sticky>
      <headNavigation leftIcon="arrow-left" :title="pageTitle ? pageTitle : '监测数据'"></headNavigation>
    </van-sticky>
    ...
    <div v-if="list.length === 0 && !loading">
      <div class="nodata">
        <img :src="require('@/assets/noNews.png')" alt="" style="width: 80%">
...
export default {
  ...
  methods: {
    ...
    HorizontalScreen () {
      this.$router.push({
        path: '/paitent/monitor/horizontalScreen',
        query: {
