<template>
  <div>
    <van-sticky>
      <headNavigation leftIcon="arrow-left" :rightIcon="dateImg" :title="pageTitle ? pageTitle : '我的药箱'"
                      @onBack="$router.go(-1)" @showpop="$router.push('/patient/medicine/history')" ></headNavigation>
    </van-sticky>
...
import Vue from 'vue'
import {Switch, Field, SwipeCell, Button, Image as VanImage, Dialog} from 'vant'
...
export default {
  data () {
    return {
      ...
      loading: false,
      Btnobj: {},
      dateImg: require('@/assets/patient/historyMedicine.png'),
