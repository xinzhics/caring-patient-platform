<template>
  <section style="background:#FAFAFA" class="mian1">
    ...
    <van-search v-model="hospitalName" placeholder="搜索" @input="onInput" @blur="onBlur" @focus="onFocus"  show-action>
      <div slot="action" @click="onSearchlist">
        <van-button type="info" @click="onSearchlist">搜索</van-button>
      </div>
    </van-search>
