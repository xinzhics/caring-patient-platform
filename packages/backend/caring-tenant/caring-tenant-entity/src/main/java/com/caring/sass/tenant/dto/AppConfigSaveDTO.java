...
@Builder
@ApiModel(value = "AppConfigSaveDTO", description = "项目APP配置")
public class AppConfigSaveDTO implements Serializable {
     ...
     */
    @ApiModelProperty(value = "应用包名,规则：二级域名", required = true)
    @Length(max = 50, message = "应用包名,规则：二级域名长度不能超过50")
     ...
     * 关于我们
     */
    @ApiModelProperty(value = "关于我们", required = true)
     ...
     * 60*60应用图标
     */
    @ApiModelProperty(value = "60*60应用图标", required = true)
     ...
     * 租户id
     */
    @ApiModelProperty(value = "租户id 前端有，就传")
