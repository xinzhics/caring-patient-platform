...
import static com.caring.sass.common.constant.BizConstant.BASE_DATABASE;
import static com.caring.sass.common.constant.BizConstant.EXTEND_DATABASE;

/**
 * 初始化系统
 * <p>
 * 初始化规则：
 * caring-authority-server/src/main/resources/sql 路径存放8个sql文件 (每个库对应一个文件)
 * caring_base.sql            # 基础库：权限、消息，短信，邮件，文件等
 * data_caring_base.sql       # 基础库数据： 如初始用户，初始角色，初始菜单
 *
 * @author caring
 * @date 2019/10/25
 */
...
public class SchemaInitSystemStrategy implements InitSystemStrategy {
    ...
    public boolean initConnectWithAdditional(TenantConnectDTO tenantConnect) {
        return initConnect(tenantConnect);
    }
