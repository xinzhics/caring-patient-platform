...
@Builder
@ApiModel(value = "TextualInterpretationUserConsumptionSaveDTO", description = "文献解读能量豆消费记录")
public class TextualInterpretationUserConsumptionSaveDTO implements Serializable {
