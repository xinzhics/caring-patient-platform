...
@Builder
@ApiModel(value = "BusinessCardSaveDTO", description = "AI名片")
public class BusinessCardSaveDTO implements Serializable {
...
//    private Long doctorId;
    ...
    @Length(max = 1000, message = "个人介绍(1000字)长度不能超过300")
