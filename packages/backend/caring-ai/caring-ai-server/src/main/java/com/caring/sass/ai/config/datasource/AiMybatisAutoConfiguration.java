...
public class AiMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public AiMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
