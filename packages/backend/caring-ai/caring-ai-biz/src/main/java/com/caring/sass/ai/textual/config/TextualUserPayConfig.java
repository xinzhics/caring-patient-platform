package com.caring.sass.ai.textual.config;
...
@Data
@Component
@ConfigurationProperties(prefix = TextualUserPayConfig.PREFIX)
public class TextualUserPayConfig {

    public static final String PREFIX = "textual.wxpay";
    ...
    @ApiModelProperty(value = "重新文字解读扣费")
    private Integer reStartTextSpend;

    @ApiModelProperty(value = "创建播客创作花费")
    private Integer createPodcastSpend;

    @ApiModelProperty(value = "创建ppt花费")
    private Integer createPptSpend;

    @ApiModelProperty(value = "重新生成ppt大纲花费")
    private Integer reCreatePptOutlineSpend;
