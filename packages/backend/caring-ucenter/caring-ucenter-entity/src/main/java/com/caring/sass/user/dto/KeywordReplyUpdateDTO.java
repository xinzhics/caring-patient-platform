...
@Builder
@ApiModel(value = "KeywordReplyUpdateDTO", description = "关键字回复内容")
public class KeywordReplyUpdateDTO implements Serializable {
    ...
    @NotNull
    private List<KeywordSettingUpdateDTO> keywordSettingDTOList;
}
