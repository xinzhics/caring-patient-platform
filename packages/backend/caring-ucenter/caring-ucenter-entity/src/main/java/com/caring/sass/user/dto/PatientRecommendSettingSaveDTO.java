...
@Builder
@ApiModel(value = "PatientRecommendSettingSaveDTO", description = "运营配置-患者推荐配置")
public class PatientRecommendSettingSaveDTO implements Serializable {

    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value = "运营配置-患者推荐配置表ID 更新时候传入")
    private Long id;
