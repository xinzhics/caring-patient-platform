...
public class OauthUserController {
    ...
    public R<SysUser> getById(@PathVariable("id") Long id, @RequestBody UserQuery query) {
     ...
     * {@link com.caring.sass.oauth.api.UserApi#findUserByIds} 方法的实现类
     *
     * @param ids id
     * @return
     */
     ...
     * <p>
     * 接口和实现类的类型不一致，但也能调用，归功于 SpingBoot 的自动转换功能
     * {@link com.caring.sass.oauth.api.UserApi#findUserNameByIds} 方法的实现类
     *
     * @param ids id
     * @return
     */
