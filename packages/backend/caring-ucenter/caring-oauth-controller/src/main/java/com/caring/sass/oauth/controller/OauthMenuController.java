...
import com.caring.sass.authority.dto.auth.RouterMeta;
import com.caring.sass.authority.dto.auth.VueRouter;
...
public class OauthMenuController {
    ...
    private List<VueRouter> buildSuperAdminRouter() {
        ...
        datasourceConfig.setComponent("caring/defaults/datasourceconfig/Index");
        ...
        tenant.setComponent("caring/defaults/tenant/Index");
        ...
        globalUser.setComponent("caring/defaults/globaluser/Index");
