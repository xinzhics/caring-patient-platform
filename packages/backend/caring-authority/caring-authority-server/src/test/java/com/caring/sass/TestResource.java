...
import com.caring.sass.authority.dao.common.ParameterMapper;
...
import com.caring.sass.authority.entity.common.LoginLog;
...
public class TestResource {
    ...
    public void testDict() {
        ...
        Collection<com.caring.sass.authority.entity.common.Dictionary> dictionaryList = new ArrayList<>();
        dictionaryList.add(com.caring.sass.authority.entity.common.Dictionary.builder().type("AAA").name("BBBB").build());
