package com.caring.sass.authority.entity.auth;
...
import static com.caring.sass.common.constant.InjectionFieldConstants.ORG_ID_CLASS;
import static com.caring.sass.common.constant.InjectionFieldConstants.ORG_ID_METHOD;
import static com.caring.sass.common.constant.InjectionFieldConstants.STATION_ID_CLASS;
import static com.caring.sass.common.constant.InjectionFieldConstants.STATION_ID_NAME_METHOD;
...
public class User extends Entity<Long> {
     ...
     *  项目端超管账号
     */
    public static String ACCOUNT_ADMIN = "admin";
     ...
     * #c_core_org
     *
     * @InjectionField(api = ORG_ID_CLASS, method = ORG_ID_METHOD, beanClass = Org.class) RemoteData<Long, com.caring.sass.authority.entity.core.Org>
     */
    ...
    public User(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
                ...
                RemoteData<String, String> positionStatus, String workDescribe, LocalDateTime passwordErrorLastTime,
                Integer passwordErrorNum, LocalDateTime passwordExpireTime, String password, LocalDateTime lastLoginTime,
                LocalDate latestAccessTime) {
        this.id = id;
