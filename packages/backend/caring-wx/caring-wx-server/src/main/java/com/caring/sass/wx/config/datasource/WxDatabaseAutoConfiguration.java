...
@MapperScan(
        ...
        sqlSessionFactoryRef = WxDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${caring.database.multiTenantType}')")
public class WxDatabaseAutoConfiguration extends MasterDatabaseConfiguration {

    public WxDatabaseAutoConfiguration(MybatisPlusProperties properties,
