...
@Slf4j
@Component
public class MinRuiMerchantConfig {


    /** 商户号 */
    @Getter
    public String merchantId = "1695207060";

    /** 商户API私钥路径 */
    public static String privateKeyName = "apiclient_minrui_key.pem";

    /** 商户证书序列号  2024/07/03至2029/07/02*/
    public static String merchantSerialNumber = "440534268FC2F85CCE6C94452B9369B2C769B1FD";
    ...
    @Getter
    public String newNotifyUrl = "/api/wx/pay/anno/callback/all/1695207060";

    @Getter
    public String refundsNotifyUrl = "/api/wx/refund/anno/callback/1695207060";
