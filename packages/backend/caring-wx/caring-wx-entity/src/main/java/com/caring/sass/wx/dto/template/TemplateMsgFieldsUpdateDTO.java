...
@Builder
@ApiModel(value = "TemplateMsgFieldsUpdateDTO", description = "模板消息 属性表通过 templateId 和 TemplateMessage 表关联。")
public class TemplateMsgFieldsUpdateDTO implements Serializable {
