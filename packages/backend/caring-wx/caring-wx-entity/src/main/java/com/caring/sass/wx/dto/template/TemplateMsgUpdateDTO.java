...
@Builder
@ApiModel(value = "TemplateMsgUpdateDTO", description = "模板消息")
public class TemplateMsgUpdateDTO implements Serializable {
    ...
    @ApiModelProperty(value = "模板消息的属性")
    private List<TemplateMsgFieldsUpdateDTO> fields;
}
