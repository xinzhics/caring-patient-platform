...
@Builder
@ApiModel(value = "TemplateMsgFieldsPageDTO", description = "模板消息 属性表通过 templateId 和 TemplateMessage 表关联。")
public class TemplateMsgFieldsPageDTO implements Serializable {
