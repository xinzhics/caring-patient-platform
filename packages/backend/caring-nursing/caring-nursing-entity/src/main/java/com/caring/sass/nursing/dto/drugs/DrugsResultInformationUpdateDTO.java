...
@Builder
@ApiModel(value = "DrugsResultInformationUpdateDTO", description = "患者管理-用药预警-预警结果表")
public class DrugsResultInformationUpdateDTO implements Serializable {
    ...
    private LocalDateTime drugsEndTime;
    /**
     * 预警条件ID
     */
    ...
    /**
     * 模板消息发送状态 (1 未发送， 2 已发送)
     */
    @ApiModelProperty(value = "模板消息发送状态 (1 未发送， 2 已发送)")
