...
@Builder
@ApiModel(value = "FormResultScoreUpdateDTO", description = "表单结果的成绩计算")
public class FormResultScoreUpdateDTO implements Serializable {
    ...
    private Integer formResultSumAverageScore;
    /**
     * 各分组成绩json数据对象
     */
