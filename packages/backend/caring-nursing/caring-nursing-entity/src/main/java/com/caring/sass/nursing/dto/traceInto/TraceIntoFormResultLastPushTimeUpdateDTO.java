...
@Builder
@ApiModel(value = "TraceIntoFormResultLastPushTimeUpdateDTO", description = "选项跟踪患者最新上传时间记录表")
public class TraceIntoFormResultLastPushTimeUpdateDTO implements Serializable {
