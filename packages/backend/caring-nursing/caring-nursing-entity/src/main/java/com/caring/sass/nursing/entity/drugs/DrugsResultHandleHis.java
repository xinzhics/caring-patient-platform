...
@TableName("t_nursing_drugs_result_handle_his")
@ApiModel(value = "DrugsResultHandleHis", description = "患者管理-用药预警-预警处理历史表")
@AllArgsConstructor
public class DrugsResultHandleHis extends Entity<Long> {
    ...
    @Builder
    public DrugsResultHandleHis(Long id, LocalDateTime createTime, Long createUser, Long updateUser, LocalDateTime updateTime, 
                    Integer warningType, Long patientId, String patientName, String avatar, Long doctorId, 
                    String doctorName, LocalDateTime handleTime, Long handleUser, Integer clearStatus, Long drugsConditionId, Long drugsId, 
                    String drugsName, String spec, String manufactor, Long reminderTime, String buyingMedicineUrl, Long templateMsgId) {
        this.id = id;
