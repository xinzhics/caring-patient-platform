 ...
 */
@Data
@ApiModel(value = "FieldRadio", description = "单选题类型")
public class FieldRadio{
    ...
    Integer itemAfterHasEnter;

    @ApiModelProperty(value = "选项输入框 后面得输入框是否为 必填")
    Integer itemAfterHasEnterRequired;

    @ApiModelProperty(value = "选项输入框 后面得输入框 可以写多少字")
    Integer itemAfterHasEnterSize;
