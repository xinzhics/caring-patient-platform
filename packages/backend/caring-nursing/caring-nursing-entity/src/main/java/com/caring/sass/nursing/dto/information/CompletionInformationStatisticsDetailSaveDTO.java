...
@Builder
@ApiModel(value = "CompletionInformationStatisticsDetailSaveDTO", description = "信息完整度区间统计详细表")
public class CompletionInformationStatisticsDetailSaveDTO implements Serializable {
