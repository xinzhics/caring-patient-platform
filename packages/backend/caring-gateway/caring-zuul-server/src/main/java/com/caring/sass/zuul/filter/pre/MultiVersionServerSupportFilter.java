package com.caring.sass.zuul.filter.pre;

import cn.hutool.core.util.StrUtil;
import com.caring.sass.utils.StrPool;
import com.caring.sass.zuul.filter.BaseFilter;
 ...
 * <p>
 * 使用场景:
 * 用户caring，在启动 caring-authority-server 时， 将改成 spring.application.name: caring-authority-server-caring ，
 * 通过在请求每个请求头中增加 serviceSuffix=caring , 请求就能通过网关路由到 caring 的机器上
 * <p>
 * 该过滤器请勿使用在正式环境
 *
 * @author caring
