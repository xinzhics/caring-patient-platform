...
@Builder
@ApiModel(value = "FileClassificationPageDTO", description = "图片分组")
public class FileClassificationPageDTO implements Serializable {
    ...
    private ClassificationBelongEnum classificationBelong;
