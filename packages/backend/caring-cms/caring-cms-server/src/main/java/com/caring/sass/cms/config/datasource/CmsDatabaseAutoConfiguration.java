package com.caring.sass.cms.config.datasource;
...
public class CmsDatabaseAutoConfiguration extends MasterDatabaseConfiguration {
    public CmsDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 caring.database.multiTenantType!=DATASOURCE，启用了 AuthorityDatabaseAutoConfiguration");
    }
