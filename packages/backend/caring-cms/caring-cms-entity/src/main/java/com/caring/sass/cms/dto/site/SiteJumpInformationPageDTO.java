...
@Builder
@ApiModel(value = "SiteJumpInformationPageDTO", description = "建站组件元素跳转信息")
public class SiteJumpInformationPageDTO implements Serializable {
     ...
     * 本地视频，视频地址
     */
    @ApiModelProperty(value = "本地视频，视频地址")
