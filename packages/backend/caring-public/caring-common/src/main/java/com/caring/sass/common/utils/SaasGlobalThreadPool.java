 ...
 *
 */
public class SaasGlobalThreadPool {
    private static ExecutorService executor;

    private SaasGlobalThreadPool() { }
    ...
    synchronized public static void init() {
        ...
        NamedThreadFactory threadFactory = new NamedThreadFactory("saas-global-", false);
        executor = new ThreadPoolExecutor(3, 6, 0L,
