...
class CacTest {
    ...
    @Cacheable(value = "caring", keyGenerator = "keyGenerator")
    public User caring() {
        return User.builder()
                .account("caring").name("张三李四!@#$%^&*()_123")
                .id(6079967614237410571L)
                .sex(Sex.M)
                .createTime(LocalDateTime.now())
                .build();
...
public class CacheTest {
    ...
    public void testCacheable() throws Exception {
        ...
        log.info("caring={}", cacheTest.caring());
    ...
    public void testCache() {
        ...
        cacheRepository.setExpire("caring", user, 3);

        String wz = cacheRepository.get("wz");
        User user2 = cacheRepository.get("caring");
        System.out.println(wz);
        System.out.println(user2);
        System.out.println(cacheRepository.del("wz2"));
        User user3 = cacheRepository.get("caring");
