...
public class PatientDeleteMessageListener implements MessageListener {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        if (SaasRedisBusinessKey.getPatientDeleteKey().equals(channel)) {
            ...
            String handleKey = SaasRedisBusinessKey.getPatientDeleteHandleKey("msgs", messageDto.getBusinessId());
            handleMessage(messageString, handleKey);
        }
    }

    protected void handleMessage(String message, String handleKey) {
