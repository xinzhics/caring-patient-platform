package com.caring.sass.msgs.bot.service;
...
/**
 * 卡柠OpenAiService 通过继承修改BASE_URL地址
 *
 * @author leizhi
 */
public class CaringOpenAiService {
    private static final String BASE_URL = "https://service-cj1uvcdg-1256185278.hk.apigw.tencentcs.com/";

    //private static final String BASE_URL = "https://openai.23232354.xyz/";
    ...
    /**
     * Creates a new CaringOpenAiService that wraps OpenAiApi
     *
     * @param token OpenAi token string "sk-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
     */
    public CaringOpenAiService(final String token) {
     ...
     */
    public CaringOpenAiService(final String token, final Duration timeout) {
     ...
     */
    public CaringOpenAiService(final OpenAiApi api) {
        this.api = api;
    }
