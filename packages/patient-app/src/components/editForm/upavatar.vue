<template>
    <section class="contentavater">
        <div class="avaterCont" >
            <img v-if="!loadingImgCan&&filesList[0].attrValue" :class="mytype==='1'?'othershow':'show'" width="100%" :src="filesList[0].attrValue" alt="">
            <img v-if="!loadingImgCan&&!filesList[0].attrValue" :class="mytype==='1'?'othershow':'show'" width="100%" :src="loaderImg" alt="">
            <img v-if="loadingImgCan" :class="mytype==='1'?'othershow':'show'" style="background:#f5f5f5" width="100%" :src="loadingImg" alt="">
...
export default {
    ...
    data(){
        return{
            showOne:false,
            upimg:false,
            loaderImg:require('@/assets/my/imgIcon.png'),
            upmyImg:'',
            icon:require('@/assets/my/imgIcon.png'),
            resultList:[],
